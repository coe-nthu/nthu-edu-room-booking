...
export async function getDocumentDownloadContent(): Promise<DocumentDownloadContent> {
  ...
  if (settingsResult.error) {
    console.error("Error fetching document download settings:", settingsResult.error)
  }
...
export async function uploadDocumentDownloadFile(formData: FormData): Promise<DocumentDownloadFile> {
