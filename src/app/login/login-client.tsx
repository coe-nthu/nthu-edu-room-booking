...
export default function LoginClient({
  ...
  const [resetDialogNotice, setResetDialogNotice] = useState("");
  ...
  const [signUpUserType, setSignUpUserType] = useState<
    "teacher" | "staff" | "assistant" | "student" | ""
  >("");
      ...
      const { data, error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: {
            ...
            phone: signUpPhone,
            department_id: signUpDepartmentId
              ? Number(signUpDepartmentId)
              : null,
            user_type: signUpUserType,
            supervisor_name:
              signUpUserType === "student" ? signUpSupervisor : null,
          },
        },
      });
    ...
    <div className="w-full min-h-screen lg:grid lg:grid-cols-2">
      ...
      <div className="relative w-full h-[30vh] lg:h-full bg-muted">
        ...
        <div className="absolute bottom-6 left-6 lg:bottom-10 lg:left-10 z-20 text-white p-4">
          <h2 className="text-2xl lg:text-3xl font-bold mb-1 lg:mb-2">
            竹師教育學院
          </h2>
          ...
          <div className="grid gap-6">
            {authView === "sign_in" ? (
              ...
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-user-type">
                    身份別 <span className="text-red-500">*</span>
                  </Label>
                  <Select
                    value={signUpUserType}
                    onValueChange={(
                      value: "teacher" | "staff" | "assistant" | "student",
                    ) => setSignUpUserType(value)}
                  >
                ...
                {signUpUserType === "student" && (
                  <div className="space-y-2">
                    <Label htmlFor="signup-supervisor">
                      上司老師 <span className="text-red-500">*</span>
                    </Label>
                    <Input
